...
var TYPES = ['css', 'js'];
var COPY_OPTIONS = ['minify', 'useOriginalAssets', 'basePath', 'rootPath', 'cacheID'];
...
TYPES.forEach(function(type) {
  AssetMan.prototype['render' + type.toUpperCase()] =
  AssetMan.prototype['get' + type.toUpperCase() + 'Tags'] = function(names) {
    var self = this;
...
AssetMan.prototype.getAssetTags = AssetMan.prototype.renderAsset = function(names) {
  return this.renderCSS(names) + this.renderJS(names);
}
