...
var AssetMan = module.exports = function(options) {
  ...
  this.options.inputDirectory = this.options.inputDirectory || this.options.staticDirectory;
  ...
  TYPES.forEach(function(type) {
    ...
    options[type].inputDirectory = options[type].inputDirectory || options.inputDirectory + '/' + type;
